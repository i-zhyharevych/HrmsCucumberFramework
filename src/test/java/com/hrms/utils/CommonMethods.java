...
public class CommonMethods extends PageInitializer {
	...
	public static byte[] takeScreenshot(String fileName) {
		...
		// this lines are kept to have screendshot folder
		Date date = new Date();
	...
	/**
	 * This method will select an option in drop down list by visible text
	 * 
	 * @param element
	 * @param visibleText
	 */
	...
	/**
	 * This method will select an option in drop down list by index
	 * 
	 * @param element
	 * @param index
	 */
	public static void selectDdValue(WebElement element, int index) {
		...
		if (!isFound) {
			System.out.println("Value " + index + " was not found in the dropdown");
		}

	}

	/**
	 * This method will click on the radiobutton based on the text
	 * 
	 * @param elements
	 * @param radioText
	 */
